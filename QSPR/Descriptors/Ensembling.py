...
def main():
    ...
    early_stopping = EarlyStopping(patience=params['earlystopping_patience'],
                                   path='checkpoint_ensemble_' + params['Dataset'] + '_ANN' + '.pt')
    n_param = count_parameters(model)
    print(params["Dataset"], n_param)
...
if __name__ == "__main__":
    ...
    active_function_l = [0, 1, 1, 1]
    num_hidden_l = [1, 5, 5, 1]
    hidden_dim_l = [113, 90, 91, 108]
    dropout_l = [0, 0.10, 0, 0.40]
    init_lr_l = [-3, -3, -3, -3]
    decay_l = [0, 0, 0, 0]
    lr_reduce_l = [0.90, 0.70, 0.85, 0.65]
    ...
    for i in range(4):
        ...
        for j in range(1):
            ...
            path = '/Ensembles/' + f'{params["Dataset"]}_ANN'
            name = '{}_{}_{}'.format('Ensemble', params['Dataset'], 'ANN')
